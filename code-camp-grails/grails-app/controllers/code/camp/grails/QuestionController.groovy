...
class QuestionController {
    ...
    def matchers = [
            ...
            /which of the following numbers is the largest: (.+)/: { extractNumbers(it[0][1]).max() },
            ...
            /which of the following numbers are primes: (.+)/: { extractNumbers(it[0][1]).findAll { (it as BigInteger).isProbablePrime(99) }.join(", ") }
    ]
    ...
    private List<Integer> extractNumbers(String string) {
        string.split(", ") as List<Integer>
    }
